...
Deno.serve(async request => {
  ...
  const url = Deno.env.get('SUPABASE_URL'); const service = Deno.env.get('BACKEND_SERVICE_ROLE_KEY') || Deno.env.get('SUPABASE_SERVICE_ROLE_KEY') || Deno.env.get('SUPABASE_SECRET_KEY');
