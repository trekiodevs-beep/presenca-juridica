...
const VERSION = '1.1 — 16 de setembro de 2026';
...
const documents = {
  ...
  privacidade: {
    ...
    sections: [
      ...
      ['Dados do Google Agenda', 'Quando o usuário autoriza a integração, acessamos a identificação básica da Conta Google, a lista de agendas disponíveis e os eventos necessários para sincronizar compromissos entre o Presença Jurídica e a agenda selecionada. Esses dados são usados exclusivamente para fornecer a integração solicitada pelo usuário.'],
      ['Armazenamento e compartilhamento dos dados Google', 'Armazenamos identificadores da agenda, eventos sincronizados e credenciais de autorização protegidas para manter a integração ativa. Não vendemos dados Google, não os utilizamos para publicidade e não os compartilhamos com terceiros, exceto provedores essenciais de infraestrutura que atuam sob obrigações de segurança e somente na medida necessária para operar o serviço.'],
      ['Controle da integração Google', 'O usuário pode desconectar ou renovar a autorização do Google Agenda nas configurações do Presença Jurídica e também revogar o acesso pela página de segurança da Conta Google. A revogação interrompe novos acessos; dados previamente sincronizados seguem as regras de retenção e exclusão desta política e as obrigações legais aplicáveis.'],
