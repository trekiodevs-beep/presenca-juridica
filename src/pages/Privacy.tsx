...
export const Privacy = () => {
  ...
  const handleDeletion = async () => {
    if (!canManage || !window.confirm('Agendar a exclusão do escritório para daqui a 30 dias?')) return;
    ...
    catch (error) { console.error(error); showToast('Não foi possível agendar a exclusão.', 'error'); }
  };
